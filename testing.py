...
sim_kwargs = {
    ...
    'state_buffer_skip': 250,
    'state_buffer_preset_times': [1, 10, 100, 1000, 5000],
}
...
print('\nSimulation complete!' + ' '*20)
state_buffer_length = sim.state_buffer.length
print(f'{state_buffer_length = }')


fetched_states = sim.state_buffer.get_states()
fetched_times = sim.state_buffer.get_times()
sim.plot_states(states=fetched_states, times=fetched_times, size=2)
